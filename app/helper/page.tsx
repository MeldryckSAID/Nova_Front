...
export default function HelperListPage() {
  ...
  useEffect(() => {
    ...
    if (dayFilter !== 'all') {
      filtered = filtered.filter((helper) =>
        helper.timeSlots.some((slot) => slot.day === dayFilter)
      );
    }
  ...
  const allSpecialties = Array.from(
    new Set(helpers.flatMap((helper) => helper.specialties))
  ).sort();
        ...
        <div className="py-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold text-royal-blue dark:text-white mb-4">
                Nos Helpers
              </h1>
              <p className="text-primary-text/70 dark:text-dark-base-text/70 max-w-2xl mx-auto">
                Découvrez tous nos experts disponibles pour vous accompagner
              ...
              {filteredHelpers.map((helper) => (
                ...
                >
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-xl text-primary-text dark:text-dark-base-text">
                      {helper.name}
                    </CardTitle>
                    <div className="flex justify-center space-x-2">
                      ...
                      {helper.rating && (
                        <Badge className="bg-royal-blue text-white border-royal-blue/20">
                          ⭐ {helper.rating}
                        </Badge>
                      )}
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <h4 className="font-semibold mb-2 text-primary-text dark:text-dark-base-text">
                        Spécialités
                      </h4>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        {helper.timeSlots.slice(0, 2).map((slot) => (
                          <div
                            key={slot.id}
                            className="text-sm text-primary-text/70 dark:text-dark-base-text/70"
                          >
                    ...
                    <div className="flex space-x-2">
                      ...
                      {helper.timeSlots.length > 0 && (
                        ...
                        >
                          <Button className="flex-1 bg-royal-blue hover:bg-royal-blue/90 text-white">
                            Réserver
                          </Button>
                        </BookingModal>
                      )}
