...
export function TimeSlotSelector({ timeSlots, onChange, maxSlots = 5 }: TimeSlotSelectorProps) {
  ...
  const updateRecurring = (id: string, isRecurring: boolean) => {
    onChange(timeSlots.map((slot) => (slot.id === id ? { ...slot, isRecurring } : slot)))
  }
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-4">
                    <span className="font-medium text-primary-text dark:text-dark-base-text">{slot.day}</span>
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => updateRecurring(slot.id, checked as boolean)}
                      />
                      <Label
      ...
      {timeSlots.length < maxSlots && (
        <div className="bg-white dark:bg-blue-gray-dark rounded-lg shadow-lg border border-light-blue-gray/20 dark:border-royal-blue/30">
          <div className="p-6 pb-2">
            <h3 className="text-lg font-semibold text-primary-text dark:text-dark-base-text">Ajouter un créneau</h3>
          </div>
          <div className="p-6 pt-2 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <Label htmlFor="startTime" className="text-primary-text dark:text-dark-base-text">
                  Heure de début
                </Label>
                <Select
              ...
              <div>
                <Label htmlFor="endTime" className="text-primary-text dark:text-dark-base-text">
                  Heure de fin
                </Label>
                <Select
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => setNewSlot((prev) => ({ ...prev, isRecurring: checked as boolean }))}
              />
              <Label htmlFor="newRecurring" className="text-primary-text dark:text-dark-base-text">
